...
uint_least8_t wifi_mask = WIFI_PROTOCOL_11B | WIFI_PROTOCOL_11G | WIFI_PROTOCOL_11N | WIFI_PROTOCOL_LR;
...
esp_err_t init_wifi(wifi_mode_t mode)
{
    ...
    __MSX_DEBUG__( esp_wifi_set_protocol(ESPNOW_WIFI_IF, wifi_mask) );
